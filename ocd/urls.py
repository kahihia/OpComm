...
urlpatterns = [
    ...
    re_path(r'^unsubscribe/(?P<uid>[a-z0-9]{32})/$', UnsubscribeView.as_view(), name="unsubscribe"),
    re_path(r'^invitation/(?P<code>[a-z0-9]{%d})/$' % CODE_LENGTH, AcceptInvitationView.as_view(),
    ...
    # E-Mail Pixel code
    path('pixel/opcomm.gif/', users.views.EmailPixelView.as_view(), name='email_pixel'),
]
